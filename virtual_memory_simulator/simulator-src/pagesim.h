 ...
 * Memory parameters.
 *
* These values come from the simulator command line.
 */
...
/* These values are initialized by the simulator and managed by the scheduler. */
...
/* This state is initialized and managed by the simulator. */
